...
public class Osric
{
	...
	public static void main(String[] args)
	{
		...
		while(Selection != 11)
		{
			...
			Selection = Get_Input.readSelection(11); 
	...
	public static void MaintainTechnician()
	{
		...
		while(Selection != 4)
		{
         ...
         System.out.println("	2) Complain technician");
            ...
            case 2:
					maintainTechnician = new Maintain_Technician();
					maintainTechnician.complainTechnician();
					System.out.println("\nYour complaint is successfully added.\nSorry for inconvinence\nWe are assure you that we will take strong action");
					break;
